      ...
      <section className="py-24 bg-brand-black relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            <div
              className="cursor-pointer bg-brand-dark p-8 rounded-2xl border border-neutral-800 text-center hover:border-opacity-100 transition-colors"
              style={{ borderColor: "rgba(64,64,64,0.5)" }}
              onClick={() => navigate("/mediums")}
            >
              <div
              ...
              <h3 className="font-serif text-xl text-white mb-4">
                Các phương tiện đọc sách
              </h3>
              <p className="text-neutral-400 text-sm leading-relaxed">
                Mỗi cuốn sách đều được lựa chọn kỹ lưỡng. Mình tập trung vào
                chất lượng hơn số lượng, đảm bảo mỗi gợi ý đều mang lại giá trị.
              </p>
            </div>
            <div
              className="cursor-pointer bg-brand-dark p-8 rounded-2xl border border-neutral-800 text-center hover:border-opacity-100 transition-colors"
            ...
            >
              ...
              <p className="text-neutral-400 text-sm leading-relaxed">
                Những suy nghĩ khách quan về văn học. Mình khám phá những ý
                nghĩa sâu sắc hơn và cách chúng áp dụng vào cuộc sống hiện đại.
              </p>
            </div>
            <div
              className="cursor-pointer bg-brand-dark p-8 rounded-2xl border border-neutral-800 text-center hover:border-opacity-100 transition-colors"
            ...
            >
              ...
              <p className="text-neutral-400 text-sm leading-relaxed">
                Tham gia cộng đồng của những người đọc chậm và nghĩ sâu. Hãy
                cùng thảo luận về những ý tưởng quan trọng.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="space-y-8">
            {recentBooks.map((book, idx) => (
              <Link
                to={`/blog/${book._id || book.id}`}
                key={book._id || book.id}
                className="group flex items-center justify-between border-b border-neutral-800 pb-8 hover:border-neutral-600 transition-colors"
              >
                <div className="flex items-center space-x-6">
                  ...
                  <div>
                    <h3
                      className="text-xl md:text-2xl text-white font-serif transition-colors"
                      onMouseEnter={(e) =>
                        (e.currentTarget.style.color = config.themeColor)
                      }
                      onMouseLeave={(e) =>
                ...
                <div className="hidden md:block">
                  <span className="text-neutral-500 text-sm uppercase tracking-wider group-hover:text-white transition-colors">
                    {book.category}
                  </span>
                </div>
              </Link>
